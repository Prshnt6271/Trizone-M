...
const AnimatedLetters = ({ text, scrollYProgress, range = [0, 0.3] }) => {
  ...
  return letters.map((letter, i) => {
    ...
    const color = useTransform(scrollYProgress, [start, end], ['#999', '#fff']);
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 relative">
        ...
        <div className="w-full md:w-1/2 space-y-6 z-10">
          ...
          <p className="text-white font-medium text-base md:text-lg">
            Architecture is more than buildings; it's about form, light, and
            human connection. Our approach combines functionality and timeless
            aesthetics to create structures that resonate with their environment
            and purpose.
          </p>
        </div>

        {/* Right Side: Poster with Rotating Images */}
        <div className="relative w-full md:w-1/2 h-[320px] md:h-[420px] overflow-hidden flex items-center justify-center bg-gray-900 rounded-2xl">
          ...
          />
          <div className="relative w-[85%] h-[85%] overflow-hidden z-10 shadow-lg rounded-xl">
